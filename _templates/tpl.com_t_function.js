 ...
 * Description: com_t_function数据表
 * inject:xwenterprisenumber,functionid,xwfunctiontype=>int
 */
module.exports = function() {
    var template = "IF EXISTS(SELECT 1 FROM com_t_function  WHERE systemcode='{{xwsystemcode}}' and functioncode='{{xwfunctioncode}}' and enterpriseid={{xwenterprisenumber}})\r\n";
    template += "   BEGIN\r\n";
    template += "      UPDATE [dbo].[com_t_function]\r\n";
    ...
    template += "ELSE\r\n";
    template += "   BEGIN\r\n";
    template += "       INSERT INTO [dbo].[com_t_function]\r\n";
