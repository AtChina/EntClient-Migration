 ...
 * Description: com_t_localfield数据表
 * inject:xwenterprisenumber
 */
module.exports = function() {
    var template = "IF EXISTS(SELECT 1 FROM com_t_localfield  WHERE xwfieldid='{{xwfieldid}}' and xwdatasourceid='{{xwdatasourceid}}')\r\n";
    template += "   BEGIN\r\n";
    template += "      UPDATE [dbo].[com_t_localfield]\r\n";
    ...
    template += "ELSE\r\n";
    template += "   BEGIN\r\n";
    template += "       INSERT INTO [dbo].[com_t_localfield]\r\n";
    template += "           ([xwfieldid]\r\n";
