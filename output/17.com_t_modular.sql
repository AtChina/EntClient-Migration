...
BEGIN
   UPDATE [dbo].[com_t_modular]
    SET [xwmodname] = '企业门户发布平台'
       ...
       ,[xwcreatetime] = 'Sat Mar 03 2012 21:40:45 GMT+0800 (China Standard Time)'
       ,[xwmodkey] = '1                   '
       ,[xwprimarykey] = '1                                                 '
...
BEGIN
  ...
  VALUES
        ...
        ,'1008413'
        ,'208126'
        ,'Sat Mar 03 2012 21:40:45 GMT+0800 (China Standard Time)'
        ,'1                   '
        ,'1                                                 '
        ,'SYS10001');
END  COMMIT TRANSACTION com_t_modular_transaction;
END TRY
BEGIN CATCH
    SELECT
